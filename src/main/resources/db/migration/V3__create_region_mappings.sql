-- 지역 매핑 테이블 생성 (region_mappings가 V2에서 이미 생성되었으므로 조건부 생성)
...
-- 초기 지역 매핑 데이터 삽입
INSERT INTO region_mappings (main_region, adjacent_region, priority_order) VALUES
-- 서울
('서울', '경기', 1),
('서울', '인천', 2),
...
-- 테이블 코멘트 추가
COMMENT ON TABLE region_mappings IS '지역 인접 관계 매핑 테이블 - 버킷 정책 B3에서 사용';
