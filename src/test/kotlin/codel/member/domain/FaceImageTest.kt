...
class FaceImageTest {
    ...
    @DisplayName("정확히 3개의 이미지 URL로 FaceImage를 생성할 수 있다")
    @Test
    fun createFaceImage_valid() {
        ...
        // then
        assertThat(faceImage.urls).containsExactly("url1", "url2", "url3")
    }
    ...
    fun createFaceImage_tooFew() {
        ...
        assertThat(exception.message).contains("얼굴 이미지 URL은 정확히 3개여야 합니다.")
    }
